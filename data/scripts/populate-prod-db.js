...
var mongo = new Mongo('ds111461.mlab.com:11461');
var booksStoreTest = mongo.getDB(dbName);
booksStoreTest.auth('books-store', 'Gosha777');
...
var ordersColl = booksStoreTest.getCollection('orders');
itemsColl.drop();
langColl.drop();
categoriesColl.drop();
ordersColl.drop();
